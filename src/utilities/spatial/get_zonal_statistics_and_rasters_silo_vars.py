...
from src.utilities.spatial.statistical_areas_reference_regions import southern_growing_region
...
def get_zonal_statistics_and_rasters_silo_vars(var, name = ''):
    ...
    # reference masking region scopes from data dict
    sa_scope = target_data_dict['statistical_areas']

    # reference any subsets based on user-supplied functions
    regions_list = target_data_dict['regions_subsets']
